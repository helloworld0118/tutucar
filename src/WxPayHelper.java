...
import com.soft.wb.wechat.util.CommonUtil;

import net.sf.json.JSONObject;

public class WxPayHelper {
	private HashMap<String, String> parameters = new HashMap<String, String>();
	private String AppId = OrderFormAction.APP_ID;
	private String AppKey = OrderFormAction.APP_KEY;
	private String SignType = "sha1";
	private String PartnerKey =OrderFormAction.PartnerKey;
	...
	public String GetCftPackage() throws SDKRuntimeException, Exception {
		if ("" == PartnerKey) {
	...
	public String GetBizSign(HashMap<String, String> bizObj)
			throws SDKRuntimeException, Exception {
